                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="relative my-2">
                            ...
                            <div className="relative flex justify-center">
                                <span className="bg-surface/40 px-3 text-xs text-foreground/40">or continue with</span>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3">
                            <button
                                type="button"
                                onClick={() => toast.info("Google login coming soon!", { description: "We are currently setting up OAuth 2.0." })}
                            ...
                            <button
                                type="button"
                                onClick={() => toast.info("Facebook login coming soon!", { description: "We are currently setting up OAuth 2.0." })}
                                className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-border bg-surface/30 hover:bg-surface/60 transition-colors text-sm font-medium"
                            >
